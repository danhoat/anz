...
class DisplayColumnNotificationTos
{
    /**
    ...
    {
        if ( $column_name !== 'qms3_form_notification_tos' ) { return; }
    ...
    private function get_value( $post_id )
    {
        ...
        if ( ! empty( $mail_settings[ 0 ][ 'notification' ][ 'tos_str' ] ) ) {
            return array(
                $mail_settings[ 0 ][ 'notification' ][ 'tos_str' ],
                'custom'
            );
        }
        ...
        if ( ! is_null( $mail_setting[ 'notification' ][ 'tos_str' ] ) ) {
            return array(
                $mail_setting[ 'notification' ][ 'tos_str' ],
                'master'
            );
        }
