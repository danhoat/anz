...
class BackWPup_Pro
{
	...
	public function register_destination( $destinations ) {
        ...
        $destinations['ONEDRIVE'] = [
            'class' => 'BackWPup_Pro_Destination_OneDrive',
            'info' => [
                'ID' => 'ONEDRIVE',
                'name' => __('OneDrive', 'backwpup'),
                'description' => __('Backup to Microsoft OneDrive', 'backwpup'),
            ],
            'can_sync' => false,
            'needed' => [
                'php_version' => '',
                'functions' => ['curl_init', 'json_decode', 'http_build_query'],
                'classes' => [],
            ],
        ];
        // backup to HiDrive
        $destinations['HIDRIVE'] = array(
            'class' => 'BackWPup_Pro_Destination_HiDrive',
            'info' => array(
                'ID' => 'HIDRIVE',
                'name' => __( 'HiDrive', 'backwpup' ),
                'description' => __( 'Backup to HiDrive', 'backwpup' ),
            ),
            'can_sync' => false,
            'needed' => array(
                'php_version' => '',
    ...
    public function init()
    {
        ...
        $onedriveDestination = new BackWPup_Pro_Destination_OneDrive_Authorization();
        add_action('wp_loaded', [$onedriveDestination, 'getAccessToken']);
    }
}
