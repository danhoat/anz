...
export const CheckboxField: VFC<Props> = ({ structure }) => {
  return (
    <div className={ className('brick-form__field-unit', 'brick-form__field-unit-checkbox', 'brick-form__field-unit--step-input', structure.required ? 'brick-form__field-unit--required' : 'brick-form__field-unit--optional') } >
      { !!structure.prepend && (
      ...
      <div className="brick-form__field">
        ...
        <div className={ className('brick-form__options', 'brick-form__options-checkbox', `brick-form__options-name-${structure.name}`) } >
          { parse(structure.options).map((label, index) => (
            <div className="brick-form__options-item brick-form__options-item--checkbox">
              <input
