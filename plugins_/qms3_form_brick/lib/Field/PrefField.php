...
use QMS3\Brick\Option\PrefOption;
use QMS3\Brick\OptionsFactory\PrefOptionsFactory;
 ...
 * @property-read    PrefOption[]    $options
...
class PrefField extends Field
{
    ...
    {
        $factory = new PrefOptionsFactory($this, $this->values, $this->step);
    ...
    {
        return $this->template->render(
            $this->value ? "select.confirm" : "select.confirm.empty",
            [
                "field"  => $this,
